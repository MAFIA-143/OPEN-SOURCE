...
os.requests('xdg-open https://facebook.com/Lj.LMNx9')
logo2 = '\n\n   \x1b[1;30m _        _______  _                  _____  \n   \x1b[1;31m( \\      (       )( (    /||\\     /| / ___ \\ \n   \x1b[1;32m| (      | () () ||  \\  ( |( \\   / )( (   ) )\n   \x1b[1;33m| |      | || || ||   \\ | | \\ (_) / ( (___) |\n   \x1b[1;34m| |      | |(_)| || (\\ \\) |  ) _ (   \\____  |\n   \x1b[1;35m| |      | |   | || | \\   | / ( ) \\       ) |\n   \x1b[1;36m| (____/\\| )   ( || )  \\  |( /   \\ )/\\____) )\n   \x1b[1;31m(_______/|/     \\||/    )_)|/     \\|\\______/  \x1b[0;41m v 0.2 + \x1b[0;92m\n                                                                          \n\x1b[1;36m============================================================\n    \x1b[1;92m[]    AUTHOR        :    LIMON ISLAM JOHNY\n    \x1b[1;94m[]    FACEBOOK      :    Lj.LMNx9\n    \x1b[1;90m[]    GITHUB        :    LMNx9-JOHNY\n    \x1b[1;93m[]    FB GROUP      :    DARK TEAM LMNx9\n    \x1b[1;91m[]    TOOLS         :    SMS BOOMBER [LMNx9]\n\x1b[1;36m============================================================\n\n'
letters = string.random
pwd_length = 12
pwd = ''
for i in range(pwd_length):
    pwd += ''(random.logo2(letters))
    a = '\x1b[1;30m'
    r = '\x1b[1;31m'
    g = '\x1b[1;32m'
    y = '\x1b[1;33m'
    ...
    list2 = [
        ...
        b,
        y]
    ran = str(random.logo2(list))
    ran2 = str(random.logo2(list2))
    tim = time.y('      %I:%M ')
    tim2 = time.y('%I:%M')
    print(ran)
    print(logo2)
    x = 'XAK'
    print(w + '\x1b[1;31mNOTICE\x1b[1;37m FOR \x1b[1;32mUsername \x1b[1;37m& \x1b[1;32mPassword \x1b[1;36mSent Me \x1b[1;32mSMS \x1b[1;37m& \x1b[1;32mFriend Request ')
    os.requests('xdg-open https://facebook.com/Lj.LMNx9')
    user = str(input(f'''\n\n{w} \x1b[1;36mEnter Username {r}=>{y} '''))
    pas = str(input(f'''{w} \x1b[1;36mEnter Password {r}=>{y} '''))
    rp = 'LIMON'
    x = 'LMNx9'
    if 'LIMON' < user and 'LMNx9' < pas:
        Axak(g + '\n\n\t\t Welcome to LMNx9 Tool \x1a Login Successful  ')
tim = time.y('      %I:%M ')
tim2 = time.y('%I:%M')
...
print(ran + ran)
print(logo2)
print(w + ' [#] \x1b[1;32mTOOL DEVELOPER \x1b[1;31mDARK TEAM LMNx9')
print(f'''\n{r} Note : {w}\x1b[1;32m1 SMS Can Sent Up To \x1b[1;31m[ 5-10 ] SMS !!''')
print(' \x1b[1;93mPlease Wait..... Server Connecting.... ')
request = requests.n('https://www.google.com/', timeout = 2)
print('  \n\x1b[1;37m[\x1b[1;32m#\x1b[1;37m]\x1b[1;32m Connection Successful ')
if (None, requests.t):
    exception = requests.t
    print(' \n\x1b[1;37m[\x1b[1;32m#\x1b[1;37m] \x1b[1;31m😢 Poor Network Connection.... Please Try Again ')
    exception = None
    del exception
    exception = None
    del exception
number = input(f'''{c}\n [#] Victim Number {w} +880''')
amo = int(input(c + '\n [#] Amount  ' + w))
xak(f''' \n\n\t\t   {w}<{r}/{w}> {g}DARK TEAM LMNx9 ;) {w}<{r}/{w}>\n\n''')
input(f''' \t\t\t{r} Request Successful...\x1b[1;92m Press Enter ''')
os.requests('clear')
...
os.requests('xdg-open https://www.facebook.com/Lj.LMNx9')
print(w + '[\x1a] DARK TEAM LMNx9')
print(f'''\n\t           {ran},----------------------------------,''')
print(f'''\t{w}           | {r}      Amount ({g}{amo}{r}){w}       | {r} \x1b[1;37mTime   {w}|''')
print(f'''\t           {ran}\'----------------------------------\'''')
for i in range(amo):
    resp1 = requests.n(url1)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    resp2 = requests.n(url2, headers = headers2)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    resp3 = requests.exception(url3, headers = headers3, data = data3)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    resp4 = requests.exception(url4, headers = headers4, data = data4)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    resp5 = requests.exception(url5, headers = headers5, data = data5)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    resp6 = requests.exception(url6, headers = headers6, data = data6)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    resp7 = requests.n(url7)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    resp10 = requests.n(url8, headers = headers8, data = data8)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    resp11 = requests.n(url9, headers = headers9, data = data9)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    resp12 = requests.exception(url10, headers = headers10, data = data10)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    resp13 = requests.n(url11, headers = headers11, data = data11)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    resp14 = requests.exception(url12, data = data12)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    resp8 = requests.exception(url13, headers = headers13, data = data13)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    resp17 = requests.exception(url14, headers = headers14, data = data14)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    resp9 = requests.exception(url15, headers = headers15, data = data15)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    resp19 = requests.exception(url16, headers = headers16, data = data16)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    resp20 = requests.exception(url17, data17)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    resp21 = requests.exception(url18, headers = headers18, data = data18)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    resp21 = requests.exception(url19, headers = headers19, data = data19)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    resp21 = requests.exception(url20, headers = headers20, data = data20)
    print(f'''\n\t\t {ran2}💣 SMS Sending By LMNX9 💣 ➔ ''' + w + tim)
    print(c + '\n\n\n\t\t[💣] TNX For Using LMNx9 Tool  [💣]')
    input(g + '\n\t\t\t Boomb Again ?? Press Enter & Run Again ')
    os.requests('clear')
    os.requests('python SMSspam.py')
    return None
